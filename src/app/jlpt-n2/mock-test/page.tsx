    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-10 text-center">
        <div className="bg-white rounded-2xl p-8 md:p-10 border border-slate-200 shadow-lg">
          ...
          <ShareButtons text={`我在 JLPT N2 模擬考答對了 ${correct}/${total} 題！你也來試試 💪`} url="/jlpt-n2/mock-test" />
          <div className="flex gap-3 justify-center flex-wrap mt-4">
            ...
            <a href="/jlpt-n2" className="px-6 py-2.5 rounded-xl border-2 border-rose-300 text-rose-400 font-semibold text-sm no-underline hover:bg-rose-50 transition">← 返回</a>
          </div>
        </div>
      </div>
    );
