...
const allSentences = N2_UNITS.flatMap(u => u.listening.map(l => ({ text: l.text, zh: l.zh })));
const allPassages = N2_UNITS.flatMap(u => {
    ...
    return (
      <div className="max-w-md mx-auto px-4 py-12 text-center">
        <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-lg">
          ...
          <ShareButtons text={`我在JLPT N2口說練習得了 ${avgScore}% 的成績！🎙️`} url="/jlpt-n2/speaking" />
