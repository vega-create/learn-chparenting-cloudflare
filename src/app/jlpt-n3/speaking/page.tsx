...
/* ─── Data sources ─── */
const allVocab = N3_UNITS.flatMap(u => u.vocab);
const allSentences = N3_UNITS.flatMap(u => u.listening.map(l => ({ text: l.text, zh: l.zh })));
const allPassages = N3_UNITS.flatMap(u => {
  ...
  if (mode === "menu") return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <div className="text-center mt-6">
        <a href="/jlpt-n3" className="text-sm text-red-500 hover:underline no-underline">← 回到 JLPT N3</a>
      </div>
    </div>
  );
    ...
    return (
      <div className="max-w-md mx-auto px-4 py-12 text-center">
        <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-lg">
          ...
          <ShareButtons text={`我在JLPT N3口說練習得了 ${avgScore}% 的成績！🎙️`} url="/jlpt-n3/speaking" />
