...
export default function MockTestPage() {
  ...
  useEffect(() => {
    if (phase === "result" && !mockTracked.current) {
      ...
      trackActivity({
        subject: "gept", activityType: "mock-test", activityId: "gept-intermediate-mock",
        activityName: "GEPT 中級模擬測驗", score: correct, maxScore: total,
  ...
  if (phase === "intro") return (
    <div className="max-w-2xl mx-auto px-4 py-12 text-center">
      <div className="bg-white rounded-2xl p-8 md:p-10 border border-slate-200 shadow-sm">
        ...
        <h1 className="text-2xl md:text-3xl font-black text-slate-800 mb-3">GEPT Intermediate Mock Test</h1>
        <p className="text-slate-500 mb-6">中級英檢模擬測驗（全英文出題，考完看答案）</p>
    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-10 text-center">
        <div className="bg-white rounded-2xl p-8 md:p-10 border border-slate-200 shadow-lg">
          ...
          <ShareButtons text={`我在全民英檢中級模擬考答對了 ${correct}/${total} 題！你也來試試 💪`} url="/intermediate/mock-test" />
