    ...
    <>
      ...
      {unit && seo && (
        <UnitSEOContent
          ...
          prevUnit={UNITS.find(u => u.id === uid - 1) && { id: uid - 1, title: UNITS.find(u => u.id === uid - 1)!.title }}
          nextUnit={UNITS.find(u => u.id === uid + 1) && { id: uid + 1, title: UNITS.find(u => u.id === uid + 1)!.title }}
        />
      )}
    </>
  );
