  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl font-black text-slate-800 mb-2">JLPT N1 最上級</h1>
        <p className="text-slate-500">最上級日文 · {N1_UNITS.reduce((sum, u) => sum + u.vocab.length, 0)}+ 單字 · 聽說讀寫完整練習</p>
      </div>

      <div className="grid gap-4 mb-8">
        {N1_UNITS.map((u) => (
          <Link key={u.id} href={`/jlpt-n1/unit/${u.id}`}
