...
const allListening = N1_UNITS.flatMap(u => u.listening);
const allQuiz = N1_UNITS.flatMap(u => u.quiz);
const allReading = N1_UNITS.flatMap(u => Array.isArray(u.reading) ? u.reading : [u.reading]);
...
export default function MockTestPage() {
  ...
  useEffect(() => {
    if (phase === "result" && !mockTracked.current) {
      ...
      trackActivity({
        subject: "jlpt", activityType: "mock-test", activityId: "jlpt-n1-mock",
        activityName: "JLPT N1 模擬測驗", score: correct, maxScore: total,
  ...
  if (phase === "intro") return (
    <div className="max-w-2xl mx-auto px-4 py-12 text-center">
      <div className="bg-white rounded-2xl p-8 md:p-10 border border-slate-200 shadow-sm">
        ...
        <h1 className="text-2xl md:text-3xl font-black text-slate-800 mb-3">JLPT N1 模擬測驗</h1>
    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-10 text-center">
        <div className="bg-white rounded-2xl p-8 md:p-10 border border-slate-200 shadow-lg">
          ...
          <ShareButtons text={`我在 JLPT N1 模擬考答對了 ${correct}/${total} 題！你也來試試 💪`} url="/jlpt-n1/mock-test" />
