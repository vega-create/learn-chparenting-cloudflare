...
不插電的邏輯活動 4 歲就能開始，像是排序遊戲、指令卡牌等。Scratch Jr 適合 5–7 歲的孩子，用平板就能操作。正式的 Scratch 程式設計建議 8 歲以上，這時候孩子的認字能力和邏輯思維都比較成熟，學起來比較順。重點不是年齡，而是孩子有沒有興趣、認知發展是否準備好了。

### 爸媽完全不懂程式，也能教孩子嗎？

完全可以，而且你不需要「教」，你只需要「陪」。現在的兒童程式工具設計得非常直覺，Scratch 有大量中文教學影片，孩子跟著做就能學會。爸媽的角色是提供環境、安排時間、給予鼓勵。當孩子卡關時，與其自己去找答案，不如問他「你覺得哪裡出了問題？」引導他自己思考。

### 學程式設計會不會讓孩子沉迷電腦？

寫程式跟玩手遊完全不同。程式設計是一種**創作活動**，孩子在過程中需要主動思考、設計、測試、修改，跟被動滑手機是完全不同層次的螢幕使用。就像你不會擔心孩子沉迷畫畫一樣，寫程式也是一種有建設性的創作。當然，螢幕時間還是要控制，但不用因此害怕讓孩子學程式。

### 程式補習班很貴，免費資源真的夠用嗎？

國小階段的程式啟蒙，免費資源絕對夠用。Scratch 是 MIT 開發的免費平台，全球有數百萬孩子在使用，品質有保證。Code.org 也提供完整的免費課程。再搭配我們平台上的[教育桌遊](/board-games)做不插電的邏輯訓練，孩子的基礎絕對打得穩。等國中以上想深入學 Python 或參加比賽時，再考慮付費課程也完全來得及。
